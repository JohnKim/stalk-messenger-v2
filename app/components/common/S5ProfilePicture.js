...
import S5LetterImage from "./S5LetterImage";
...
export default class S5ProfilePicture extends Component {
    ...
    if (this.props.editable) {
      return (
        <View
          ...
          <S5Icon name={"camera"} size={size / 5} color={"#808080"} style={{ opacity: 0.5, marginTop: 5 }} />
        </View>
      );
    }
  }
  ...
  renderProfileCircle() {
    ...
    var radiusStyle = { borderRadius: size / 2 };
    if (type == "rect") {
      radiusStyle = { borderRadius: size / 30 };
    }
